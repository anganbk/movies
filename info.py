...
USERNAME = environ.get('USERNAME', "https://t.me/anganbk4") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003084161492'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+eD2Fpgrwnkc3YmM1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002820902360').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://angan:angan@angan.zt9nvpm.mongodb.net/?retryWrites=true&w=majority&appName=Angan")
DATABASE_NAME = environ.get('DATABASE_NAME', "angan")
